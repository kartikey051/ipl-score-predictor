...
with st.expander("Description"):
    st.info("""A Simple ML Model to predict IPL Scores between teams in an ongoing match. Created by a team of four people consisting of Aditya,Kartikey,Chandramouli and Aryan.
